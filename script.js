(function () {
  ...
  var translations = {
    zh: {
      ...
      'hero.desc': 'v1.5.5 已公开发布：新增证据化自进化、/evolve 治理中心、多图片 Composer 与终端滚轮隔离；安装脚本会获取最新公开 Release。',
      ...
      'delivery.title': 'v1.5.5 · Evidence-backed Evolution',
      'delivery.desc': 'v1.5.5 已公开交付 TUI 可靠性收口与证据化自进化 L0-L3；历史 tag 保持不可移动，Release 与安装脚本同步指向最新公开版本。',
      'delivery.status': '已交付',
      ...
      'delivery.evolution.title': 'v1.5.5 · Evidence-backed Evolution',
      'delivery.evolution.desc': '按目标记录 Episode，以测试、Review、Git、工具结果和反馈形成证据；Memory 带 scope/citation/TTL/冲突与相关性检索；Rule 和 Skill 候选必须人工批准。当前 Skill eval 是结构化边界用例与历史证据，不冒充完整 Agent replay 或 benchmark。',
      'delivery.evolution.plan': '查看 v1.5.5 实施计划 →',
      ...
      'delivery.release': '查看 v1.5.5 Release →',
    ...
    en: {
      ...
      'hero.desc': 'v1.5.5 is now public, adding evidence-backed evolution, the /evolve governance center, multi-image composition, and terminal wheel isolation. Installers fetch the latest public Release.',
      ...
      'delivery.kicker': 'Delivery Status',
      'delivery.title': 'v1.5.5 · Evidence-backed Evolution',
      'delivery.desc': 'v1.5.5 publicly delivers the TUI reliability closure and evidence-backed evolution L0-L3. Historical tags remain immutable, while Release links and installers point to the latest public version.',
      ...
      'delivery.evolution.title': 'v1.5.5 · Evidence-backed Evolution',
      'delivery.evolution.desc': 'Each goal becomes an Episode backed by tests, review, Git, tool results, and feedback. Memories carry scope, citations, TTL, conflict state, and relevance filtering; Rule and Skill candidates always require human approval. Skill evals currently mean structured boundary cases plus historical evidence, not a completed Agent replay or benchmark.',
      'delivery.evolution.plan': 'Read the v1.5.5 implementation plan →',
      ...
      'delivery.release': 'View the v1.5.5 Release →',
