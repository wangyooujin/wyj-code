(function () {
  ...
  var translations = {
    zh: {
      ...
      'hero.desc': 'v1.5.4 已完整交付 P0/P1/P2：单二进制、原生 TUI、国内模型可信运行时、OS 级安全执行、隔离 Workflow 与多 Agent 协作，同时兼容 Claude、OpenAI 与本地端点。',
      ...
      'delivery.title': 'v1.5.4 · P0 / P1 / P2 全部交付',
      'delivery.desc': '从 v1.4.4 的可信执行基线到 v1.5.x 的完整工程控制面，原计划能力已全部进入公开版本；历史 tag 保持不可移动，后续修复通过新版本交付。',
      'delivery.status': '已交付',
      ...
      'delivery.tests.value': '672 + 1',
      'delivery.tests.label': 'workspace 通过 + 公网专项通过',
      'delivery.clippy.value': '0 warning',
      'delivery.clippy.label': 'macOS + Linux Rust 1.96.0 / 1.96.1',
      ...
      'delivery.release': '查看 v1.5.4 Release →',
      ...
      'feature.computer.desc': '模型可观察并操控本机 GUI（macOS / Windows）；v1.5.4 允许 headless/daemon 安全执行截图、窗口枚举和元素检查，点击、输入、滚动及未知动作仍失败关闭。',
    ...
    en: {
      ...
      'hero.desc': 'v1.5.4 completes the full P0/P1/P2 scope: a single-binary terminal coding agent with a native TUI, capability-aware Chinese-model runtime, OS-level sandboxing, isolated workflows, and controllable sub-agents — also compatible with Claude, OpenAI, and local endpoints.',
      ...
      'delivery.kicker': 'Delivery Status',
      'delivery.title': 'v1.5.4 · P0 / P1 / P2 fully delivered',
      'delivery.desc': 'From the v1.4.4 trusted-execution baseline through the full v1.5.x engineering control plane, every planned capability is now in a public release. Published tags remain immutable; later fixes ship as new versions.',
      ...
      'delivery.release': 'View the v1.5.4 Release →',
      ...
      'feature.computer.desc': 'The model can inspect and control the local GUI on macOS and Windows. In v1.5.4, headless/daemon sessions may safely capture screenshots, enumerate windows, and inspect elements, while clicks, typing, scrolling, and unknown actions still fail closed.',
